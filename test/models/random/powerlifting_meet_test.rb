...
class PowerliftingMeetTest < ActiveSupport::TestCase
  test "returns olympic movements" do
    ...
    assert_equal Random::PowerliftingMeet.movements, expected_movements
  end

  test "generate starting squat weight" do
    expected_range = 135..205

    weight = Random::PowerliftingMeet.opening_squat_weight
  ...
  test "generate starting bench weight" do
    ...
    weight = Random::PowerliftingMeet.opening_bench_weight
  ...
  test "generate starting deadlift weight" do
    ...
    weight = Random::PowerliftingMeet.opening_deadlift_weight
  ...
  test "generate random opening weight for squat" do
    ...
    weight = Random::PowerliftingMeet.opening_weight_for("squat")
  ...
  test "generate random opening weight for bench weight" do
    ...
    weight = Random::PowerliftingMeet.opening_weight_for("bench")
  ...
  test "generate random opening weight for deadlift weight" do
    ...
    weight = Random::PowerliftingMeet.opening_weight_for("deadlift")
