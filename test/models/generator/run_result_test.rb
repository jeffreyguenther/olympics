...
class RunResultTest < ActiveSupport::TestCase
  test "generates random speed when none is provided" do
    meet = Generator::RunResult.new(distance: 500)
  ...
  test "generates slow 500m run" do
    meet = Generator::RunResult.new(distance: 500, speed: :slow)
  ...
  test "generates medium 500m run" do
    meet = Generator::RunResult.new(distance: 500, speed: :medium)
  ...
  test "generates fast 500m run" do
    meet = Generator::RunResult.new(distance: 500, speed: :fast)
  ...
  test "generates slow 1000m run" do
    meet = Generator::RunResult.new(distance: 1000, speed: :slow)
  ...
  test "generates medium 1000m run" do
    meet = Generator::RunResult.new(distance: 1000, speed: :medium)
  ...
  test "generates fast 1000m run" do
    meet = Generator::RunResult.new(distance: 1000, speed: :fast)
  ...
  test "generates slow 5000m run" do
    meet = Generator::RunResult.new(distance: 5000, speed: :slow)
  ...
  test "generates medium 5000m run" do
    meet = Generator::RunResult.new(distance: 5000, speed: :medium)
  ...
  test "generates fast 5000m run" do
    meet = Generator::RunResult.new(distance: 5000, speed: :fast)
